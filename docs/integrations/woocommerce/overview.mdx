...
description: "Connect WooCommerce to Qefro — installation, auth, events, tools, and examples."
...
<InfoBox>
Namespace convention: events under <code>woocommerce.*</code>. Connectors emit only; FlowRunner stays in Qefro.
</InfoBox>
...
<WorkflowCard
  title="WooCommerce go-live"
  steps={[
    {title: 'Auth', description: 'Least-privilege credentials in connector env.'},
    {title: 'Webhooks', description: 'Verify signatures; map to woocommerce.* events.'},
