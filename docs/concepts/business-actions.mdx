...
Business Actions run through the shared [Business Tool Runtime](/docs/business-tools/runtime) — tool selection, validation, authentication, and logging are identical for REST and Backend SDK paths.
...
Integration guide: [Business Tools](/docs/business-tools).
...
<RelatedTopics
  topics={[
    {label: 'Business Tools guide', to: '/docs/business-tools'},
    {label: 'Business Tool Runtime', to: '/docs/business-tools/runtime'},
