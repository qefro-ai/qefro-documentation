...
sequenceDiagram
  participant User
  participant Channel as Widget / Portal / WhatsApp
...
1. Create a [Business Tool](/docs/platform/business-tools) under a workspace (REST or [OpenAPI import](/docs/guides/import-openapi)).
