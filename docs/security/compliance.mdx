...
title: "Compliance"
description: "Roadmap items such as SOC 2 and SSO/SAML."
---
...
**Compliance** — Roadmap items such as SOC 2 and SSO/SAML.

## Introduction

Roadmap items such as SOC 2 and SSO/SAML. This page explains controls, responsibilities, and how they map to Customer AI and Employee AI deployments.
