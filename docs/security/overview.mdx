...
description: "Security model for the Qefro platform."
---
...
**Security Overview** — Security model for the Qefro platform.

## Introduction

Security model for the Qefro platform. This page explains controls, responsibilities, and how they map to Customer AI and Employee AI deployments.
