...
title: "Examples"
description: "cURL, TypeScript, and Python examples."
---
...
**Examples** — cURL, TypeScript, and Python examples.

## Introduction

This page documents examples for builders integrating with `https://api.qefro.com`. Full OpenAPI export will plug into this section as it is published.
