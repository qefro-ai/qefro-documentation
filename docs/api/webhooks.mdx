...
title: "Webhooks"
description: "Verify and handle Qefro/Razorpay-related webhook patterns."
---
...
**Webhooks** — Verify and handle Qefro/Razorpay-related webhook patterns.

## Introduction

This page documents webhooks for builders integrating with `https://api.qefro.com`. Full OpenAPI export will plug into this section as it is published.
