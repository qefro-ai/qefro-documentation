...
description: "Authenticate to the Qefro REST API."
---
...
**Authentication** — Authenticate to the Qefro REST API.

## Introduction

This page documents authentication for builders integrating with `https://api.qefro.com`. Full OpenAPI export will plug into this section as it is published.
