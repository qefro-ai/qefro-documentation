...
title: "Error Codes"
description: "Common API error shapes and meanings."
---
...
**Error Codes** — Common API error shapes and meanings.

## Introduction

This page documents error codes for builders integrating with `https://api.qefro.com`. Full OpenAPI export will plug into this section as it is published.
