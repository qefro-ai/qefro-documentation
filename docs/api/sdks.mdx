---
title: "SDKs"
description: "Website widget (@qefro-ai/widget), backend framework (@qefro-ai/backend / qefro-backend-sdk / qefro-backend) for Business Tools, and calling api.qefro.com from HTTPS clients."
sidebar_label: "SDKs"
---
...
- Python: [pypi.org/project/qefro-backend](https://pypi.org/project/qefro-backend/)
...
Examples: [JS examples](https://github.com/qefro-ai/qefro-js-backend-sdk/tree/main/examples) · [Rust examples](https://github.com/qefro-ai/qefro-rust-backend-sdk/tree/main/examples) · [Python examples](https://github.com/qefro-ai/qefro-python-backend-sdk/tree/main/examples) · [Examples index](/docs/v1/examples).
