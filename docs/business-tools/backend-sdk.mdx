...
3. Select workspace → **Sync Tools** (`tools.list` + auto-register).

Details: [SDK synchronization](/docs/business-tools/sdk-synchronization).
...
<RelatedTopics
  topics={[
    ...
    {label: 'SDK synchronization', to: '/docs/business-tools/sdk-synchronization'},
