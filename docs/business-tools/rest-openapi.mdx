...
For bulk import from a spec, see [Import OpenAPI (guide)](/docs/guides/import-openapi).  
...
<Warning>
Treat OpenAPI import like granting broad API access. Always preview and deselect `DELETE`, bulk export, and admin paths before apply.
</Warning>

Full walkthrough: [Import OpenAPI](/docs/guides/import-openapi).
