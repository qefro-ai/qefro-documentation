...
- [Architecture](/docs/business-tools/architecture)
- [Runtime pipeline](/docs/business-tools/runtime)
...
<FaqAccordion
  items={[
    ...
    },
    {
      ...
      answer:
        'Encrypted at rest on REST tools and SDK connections. Never in widget JavaScript. See Security.',
    },
  ]}
/>
...
<RelatedTopics
  topics={[
    {label: 'Architecture', to: '/docs/business-tools/architecture'},
    ...
    {label: 'Identity Forwarding (Widget)', to: '/docs/platform/identity-forwarding'},
  ]}
/>
