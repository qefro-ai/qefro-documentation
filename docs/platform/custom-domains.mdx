...
Custom domains are an add-on to the default workspace subdomain (`{slug}.qefro.com`). See [Workspace Subdomains](/docs/platform/workspace-subdomains) for slug rules and reserved names.
