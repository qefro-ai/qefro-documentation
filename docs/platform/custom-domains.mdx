...
description: "Serve Internal Portal on your domain."
---
...
**Custom Domains** map a hostname you control to the Internal Portal.

## Introduction

Custom Domains is a core part of the Qefro AI Workspace Platform. This page defines the concept, how it fits the architecture, and how to operate it safely.

## Why it exists

Organizations need clear boundaries for custom domains so Customer AI and Employee AI stay accurate, permissioned, and auditable.
...
<FaqAccordion items={[
  {
    "question": "What is Custom Domains?",
    "answer": "Custom Domains map a hostname you control to the Internal Portal."
  },
  {
