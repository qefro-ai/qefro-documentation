...
:::info Scope
This page covers the **Website Widget** `identify()` API. For REST tool configuration (`END_USER_IDENTITY`), SDK `lookup.required`, and channel matrices, see **[Identity forwarding (REST)](/docs/business-tools/identity-forwarding)** and **[Identity resolution (SDK)](/docs/business-tools/identity-resolution)**.
:::
