...
description: "Pass end-user identity into Business Actions via identify()."
---
...
**Identity Forwarding** attaches verified end-user identity so actions run as that user.

## Introduction

Identity Forwarding is a core part of the Qefro AI Workspace Platform. This page defines the concept, how it fits the architecture, and how to operate it safely.

## Why it exists

Organizations need clear boundaries for identity forwarding so Customer AI and Employee AI stay accurate, permissioned, and auditable.
...
<WorkflowCard
  title="Identity Forwarding workflow"
  steps={[
...
<FaqAccordion items={[
  {
    "question": "What is Identity Forwarding?",
    "answer": "Identity Forwarding attaches verified end-user identity so actions run as that user."
  },
  {
