...
| **SDK** | `@qefro-ai/backend` / `qefro-sdk` handlers + Sync Tools | Connection signing secret; customer auth in your code |
...
- **SDK Connection** — org webhook + signing secret for `@qefro-ai/backend` / `qefro-sdk`
