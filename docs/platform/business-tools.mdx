...
:::tip Full integration guide
For architecture, REST vs SDK, identity forwarding, runtime pipeline, examples, and troubleshooting, see the dedicated **[Business Tools documentation](/docs/business-tools)**.
:::
...
Runtime architecture: [Business Tool Runtime](/docs/business-tools/runtime).
...
<RelatedTopics
  topics={[
    {label: 'Business Tools guide (hub)', to: '/docs/business-tools'},
