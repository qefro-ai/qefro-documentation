...
sidebar_label: "Teams"
title: "Teams"
description: "Group users for collaboration and access patterns."
---
...
**Teams** organize members inside an organization for workspace access.

## Introduction

Teams is a core part of the Qefro AI Workspace Platform. This page defines the concept, how it fits the architecture, and how to operate it safely.

## Why it exists

Organizations need clear boundaries for teams so Customer AI and Employee AI stay accurate, permissioned, and auditable.
...
<FaqAccordion items={[
  {
    ...
    "answer": "Teams organize members inside an organization for workspace access."
  },
  {
