...
<FaqAccordion
  items={[
    ...
    },
    {
      ...
      answer:
        'Not from the Internal Portal in V1. Business Tool execution is supported on Website Widget and WhatsApp only. The portal remains a knowledge / RAG assistant until employee delegated authentication ships. You can still configure tools in Admin Console for customer channels.',
    },
  ]}
/>
