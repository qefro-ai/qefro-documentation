...
description: "How humans and services authenticate to Qefro."
---
...
**Authentication** verifies Admin Console users, portal employees, and API clients.

## Introduction

Authentication is a core part of the Qefro AI Workspace Platform. This page defines the concept, how it fits the architecture, and how to operate it safely.

## Why it exists

Organizations need clear boundaries for authentication so Customer AI and Employee AI stay accurate, permissioned, and auditable.
...
<FaqAccordion items={[
  {
    ...
    "answer": "Authentication verifies Admin Console users, portal employees, and API clients."
  },
  {
