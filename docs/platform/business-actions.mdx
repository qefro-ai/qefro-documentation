...
description: "Secure execution of tools against customer systems of record."
---
...
A **Business Action** is an AI-invoked call to a Business Tool (REST/OpenAPI) under policy.

## Introduction

Business Actions is a core part of the Qefro AI Workspace Platform. This page defines the concept, how it fits the architecture, and how to operate it safely.

## Why it exists

Organizations need clear boundaries for business actions so Customer AI and Employee AI stay accurate, permissioned, and auditable.
...
<WorkflowCard
  title="Business Actions workflow"
  steps={[
...
<FaqAccordion items={[
  {
    "question": "What is Business Actions?",
    "answer": "A Business Action is an AI-invoked call to a Business Tool (REST/OpenAPI) under policy."
  },
  {
