...
title: "Analytics"
description: "Conversation, retrieval, and action metrics."
---
...
**Analytics** summarizes usage, quality signals, and action outcomes.

## Introduction

Analytics is a core part of the Qefro AI Workspace Platform. This page defines the concept, how it fits the architecture, and how to operate it safely.

## Why it exists

Organizations need clear boundaries for analytics so Customer AI and Employee AI stay accurate, permissioned, and auditable.
...
<FaqAccordion items={[
  {
    ...
    "answer": "Analytics summarizes usage, quality signals, and action outcomes."
  },
  {
