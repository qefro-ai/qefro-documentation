...
title: "Branding"
description: "Logos, colors, and portal appearance."
---
...
**Branding** customizes the Internal Portal and widget chrome to match your brand.

## Introduction

Branding is a core part of the Qefro AI Workspace Platform. This page defines the concept, how it fits the architecture, and how to operate it safely.

## Why it exists

Organizations need clear boundaries for branding so Customer AI and Employee AI stay accurate, permissioned, and auditable.
...
<FaqAccordion items={[
  {
    ...
    "answer": "Branding customizes the Internal Portal and widget chrome to match your brand."
  },
  {
