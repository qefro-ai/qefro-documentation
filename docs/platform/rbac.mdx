...
sidebar_label: "RBAC"
title: "RBAC"
description: "Owner, Admin, Member roles and workspace permissions."
---
...
**RBAC** controls who can configure, publish, and use AI capabilities.

## Introduction

RBAC is a core part of the Qefro AI Workspace Platform. This page defines the concept, how it fits the architecture, and how to operate it safely.

## Why it exists

Organizations need clear boundaries for rbac so Customer AI and Employee AI stay accurate, permissioned, and auditable.
...
<FaqAccordion items={[
  {
    ...
    "answer": "RBAC controls who can configure, publish, and use AI capabilities."
  },
  {
