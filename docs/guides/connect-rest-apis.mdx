...
description: "Register REST Business Tools securely."
---
...
**Connect REST APIs** is a practical guide: Register REST Business Tools securely.

## Introduction

Follow this guide to register rest business tools securely. using the Qefro Admin Console and documented APIs.
