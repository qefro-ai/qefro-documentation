...
description: "Embed and authenticate the website widget."
---
...
**Deploy Website Widget** is a practical guide: Embed and authenticate the website widget.

## Introduction

Follow this guide to embed and authenticate the website widget. using the Qefro Admin Console and documented APIs.
