...
<InfoBox>
Runnable end-to-end examples — a cancellation flow combining <code>ask</code>, <code>condition</code>, human <code>approval</code>, and an OTP-authenticated <code>tool</code> step: <a href="https://github.com/qefro-ai/qefro-js-backend-sdk/tree/main/examples/order-approval">JS</a> · <a href="https://github.com/qefro-ai/qefro-rust-backend-sdk/tree/main/examples/order-approval">Rust</a> · <a href="https://github.com/qefro-ai/qefro-python-backend-sdk/tree/main/examples/order-approval">Python</a>.
</InfoBox>
