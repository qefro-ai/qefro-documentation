...
description: "Harden tools, secrets, and identity forwarding."
---
...
**Secure Business Actions** is a practical guide: Harden tools, secrets, and identity forwarding.

## Introduction

Follow this guide to harden tools, secrets, and identity forwarding. using the Qefro Admin Console and documented APIs.
