...
description: "Use @qefro-ai/backend, qefro-backend-sdk, or qefro-backend to register handlers, connect your webhook in Admin Console, and sync tools into a workspace as Business Tools."
...
This guide registers **Business Tools** from your backend using the Qefro Backend Framework (`@qefro-ai/backend`, `qefro-backend-sdk`, or `qefro-backend`). Tools live in your code; Admin Console only manages the signed connection and syncs metadata into a workspace.
...
- Node.js 18+ (TypeScript), Rust for `qefro-backend-sdk`, **or** Python 3.9+ for `qefro-backend`
...
Published on [crates.io](https://crates.io/crates/qefro-backend-sdk). Source: [qefro-rust-backend-sdk](https://github.com/qefro-ai/qefro-rust-backend-sdk).
...
Published on [PyPI](https://pypi.org/project/qefro-backend/) (import `qefro_backend`). Source: [qefro-python-backend-sdk](https://github.com/qefro-ai/qefro-python-backend-sdk).
...
2. Forward `POST /qefro` (or your chosen path) to the Node/Rust/Python process.
...
<WorkflowCard
  ...
  steps={[
    {title: 'Install framework', description: '@qefro-ai/backend, qefro-backend-sdk, or qefro-backend + signing secret.'},
...
<FaqAccordion
  items={[
    ...
    },
    {
      ...
      answer:
        'Yes. TypeScript: github.com/qefro-ai/qefro-js-backend-sdk (examples/). Rust: github.com/qefro-ai/qefro-rust-backend-sdk (examples/basic) — install with cargo add qefro-backend-sdk from crates.io. Python: github.com/qefro-ai/qefro-python-backend-sdk (examples/) — install with pip install qefro-backend from PyPI.',
    },
  ]}
/>
