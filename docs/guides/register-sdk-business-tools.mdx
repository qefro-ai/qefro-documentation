...
description: "Use @qefro-ai/backend or qefro-sdk to register handlers, connect your webhook in Admin Console, and sync tools into a workspace as Business Tools."
...
This guide registers **Business Tools** from your backend using the Qefro Backend Framework (`@qefro-ai/backend` or `qefro-sdk`). Tools live in your code; Admin Console only manages the signed connection and syncs metadata into a workspace.
...
<WorkflowCard
  ...
  steps={[
    {title: 'Install framework', description: '@qefro-ai/backend or qefro-sdk + signing secret.'},
