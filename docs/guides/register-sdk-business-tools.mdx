...
<FaqAccordion
  items={[
    ...
    },
    {
      ...
      answer:
        'Yes. TypeScript: github.com/qefro-ai/qefro-js-backend-sdk (examples/). Rust: github.com/qefro-ai/qefro-rust-backend-sdk (examples/basic) — install with cargo add qefro-backend-sdk from crates.io.',
    },
  ]}
/>
