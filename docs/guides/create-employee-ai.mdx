...
description: "Stand up Internal Portal Employee AI with RBAC."
---
...
**Create Employee AI** is a practical guide: Stand up Internal Portal Employee AI with RBAC.

## Introduction

Follow this guide to stand up internal portal employee ai with rbac. using the Qefro Admin Console and documented APIs.
