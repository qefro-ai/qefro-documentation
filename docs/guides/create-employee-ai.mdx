...
description: "Stand up Employee AI on the Internal Portal: workspaces, Teams, RBAC grants, branding, and optional internal Business Tools."
...
- Decision on who may configure tools (usually Admins only)
...
## Step 5 — Optional internal tools

Attach internal Business Tools only to internal workspaces. Prefer read-only first. Never attach payroll-write tools to a Customer AI workspace.

See [Secure Business Actions](/docs/guides/secure-business-actions).
...
<WorkflowCard
  ...
  steps={[
    ...
    {title: 'Optional tools', description: 'Internal APIs only; least privilege.'},
  ]}
/>
