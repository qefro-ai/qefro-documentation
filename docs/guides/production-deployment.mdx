...
- [ ] Customer vs employee workspaces split; public channels bound only to customer-safe indexes
- [ ] DPA / questionnaire completed if required
- [ ] Staging org used for experiments when possible
- Docs: [Security Overview](/docs/security/overview), [Tenant isolation](/docs/security/tenant-isolation), [Authentication & access](/docs/security/authentication-and-access), [Compliance](/docs/security/compliance)
