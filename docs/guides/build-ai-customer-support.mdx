...
description: "Ship a support workspace with knowledge, widget, and optional actions."
---
...
**Build AI Customer Support** is a practical guide: Ship a support workspace with knowledge, widget, and optional actions.

## Introduction

Follow this guide to ship a support workspace with knowledge, widget, and optional actions. using the Qefro Admin Console and documented APIs.
