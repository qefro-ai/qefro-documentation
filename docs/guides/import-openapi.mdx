...
description: "Import OpenAPI specs into Business Tools."
---
...
**Import OpenAPI** is a practical guide: Import OpenAPI specs into Business Tools.

## Introduction

Follow this guide to import openapi specs into business tools. using the Qefro Admin Console and documented APIs.
