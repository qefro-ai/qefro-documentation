...
description: "Set Owners, Admins, Members, and workspace access."
---
...
**Configure RBAC** is a practical guide: Set Owners, Admins, Members, and workspace access.

## Introduction

Follow this guide to set owners, admins, members, and workspace access. using the Qefro Admin Console and documented APIs.
